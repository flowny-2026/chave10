      ...
      {area === 'app' && (
        <nav className="bottom-nav">
          <div className="bottom-nav-inner">
            ...
            <NavLink to="/app/clientes" className={({ isActive }) => 'bottom-nav-item' + (isActive ? ' active' : '')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
              <span className="bottom-nav-label">Clientes</span>
            </NavLink>
            <NavLink to="/app/os" className={({ isActive }) => 'bottom-nav-item bottom-nav-item-main' + (isActive ? ' active' : '')}>
              ...
              <span className="bottom-nav-label">Nova OS</span>
            </NavLink>
            <NavLink to="/app/agenda" className={({ isActive }) => 'bottom-nav-item' + (isActive ? ' active' : '')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
              <span className="bottom-nav-label">Agenda</span>
            </NavLink>
            <NavLink to="/app/financeiro" className={({ isActive }) => 'bottom-nav-item' + (isActive ? ' active' : '')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
              <span className="bottom-nav-label">Financeiro</span>
            </NavLink>
          </div>
        </nav>
      )}
