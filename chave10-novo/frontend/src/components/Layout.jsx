    ...
    <>
      ...
      {open && (
        <div style={{
          ...
          padding: '18px 20px',
          width: 260,
          animation: 'pwaSlideIn .2s ease',
        }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--gray-800)', marginBottom: 4 }}>
            💬 Suporte Chave 10
          </div>
          <div style={{ fontSize: 12, color: 'var(--gray-400)', marginBottom: 14, lineHeight: 1.5 }}>
            Fale com nossa equipe pelo WhatsApp. Atendimento rápido!
          </div>
          <a
            href={SUPORTE_WA}
            target="_blank"
